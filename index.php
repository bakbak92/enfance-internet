    ...
    <nav class="navbar navbar-default my-nav">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a href="#"><img src="img/logo-association.png" alt=""></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav-right">
            ...
            <li><a href="#">Link</a></li>
            <li class="dropdown">
              <a href="#" class="don">Faite un Don</a>
            </li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
...
<footer class="container-fluid">
  ...
  <p>Copyright 2017 - Mentions légales - réalisé par bakary</p>
</footer>
</body>
</html>
